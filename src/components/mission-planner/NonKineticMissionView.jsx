  ...
  return (
    <div className="flex flex-col h-full bg-darkest overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-4 py-2.5 border-b border-gray-700/50 flex-shrink-0">
        ...
        <span className="text-gray-500 text-[0.68rem]">Non-Kinetic Effects — CVN-78 Transit Cover — CTF-70</span>
        ...
        <input
          ...
          className="bg-gray-800/60 border border-gray-700/60 rounded-md px-3 py-1.5 text-white text-[0.78rem] w-52 placeholder-gray-600 focus:outline-none focus:border-purple-500/50 transition-colors"
        />
        <button
          onClick={handleSave}
