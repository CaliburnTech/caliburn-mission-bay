...
const useMarketplaceStore = create((set, get) => ({
  ...
  // NOTE: Deployment state is managed by deploymentStore.js (single source of truth)
  ...
  // NOTE: Deployment functions (initiateDeployment, executeDeployment, etc.)
  // have been moved to deploymentStore.js as the single source of truth
  ...
  navigateToCapability: (capabilityName) => {
    ...
    safeLocalStorage.setItem('caliburn-marketplace-view', 'capabilities');
    if (typeof window !== 'undefined') {
