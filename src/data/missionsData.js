...
export const initialMissions = [
  ...
  // MAGAZINE DEPTH — Mission 01 — Luzon Strait (Autonomy Mission Series)
  {
    ...
    missionProfile: {
      ...
      squadronComposition: {
        ...
        airborneSensor: "MQ-4C Triton — 1× — over-the-horizon radar and EO/IR feeding the fire-control picture over Link 16",
  ...
  // Distinct from the existing CONTESTED_LOGISTICS mission (Puller ESB / EABO / PAE RAS).
  {
