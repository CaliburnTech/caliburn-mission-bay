  ...
  return (
    <div className="card-accent">
      ...
      <div className="table-container">
        <div className="table-header gap-sm" style={{ gridTemplateColumns: '2fr 1.5fr 1fr 1fr 1fr 1.5fr 120px' }}>
        ...
        <div className="overflow-y-auto max-h-96">
          {filteredMissions.length === 0 ? (
            ...
            filteredMissions.map((mission, idx) => {
              ...
              return (
                <div key={mission.id} onClick={() => onSelectMission(mission)} className={`table-row gap-sm ${idx % 2 === 1 ? 'table-row-alt' : ''}`} style={{ gridTemplateColumns: '2fr 1.5fr 1fr 1fr 1fr 1.5fr 120px' }}>
