...
import { KEY_MISSIONS, hierarchyPresets, nodeTypes } from './constants';
...
const MissionConfigView = ({ mission, onBack, onSave }) => {
  ...
  const [zoneConfig, setZoneConfig] = useState(
    mission?.zoneConfig || { name: '', coordinates: [{ lat: 25.0, lng: -80.0 }, { lat: 25.5, lng: -80.0 }, { lat: 25.5, lng: -79.5 }, { lat: 25.0, lng: -79.5 }] }
  );
  ...
  return (
    <div className="flex flex-col gap-4 min-h-[600px]">
      ...
      <div className="flex gap-4 flex-1">
        ...
        <div className="flex-1 bg-darker rounded-lg border border-border-subtle overflow-hidden flex flex-col relative">
