...
const MarketplacePage = () => {
  ...
  const {
    ...
    outfitterCart, setOutfitterCart, addToOutfitterCart,
    selectedFilters, setSelectedFilters, toggleFilter, clearAllFilters, getFilteredItems,
    ...
    isFullScreenConfig, setIsFullScreenConfig,
    availableSlots, setAvailableSlots, addNewSlot, removeSlot,
    selectedCategory, setSelectedCategory,
    selectedCapabilityDetails, setSelectedCapabilityDetails,
    draggedCapability, setDraggedCapability,
    slotPositions, setSlotPositions, updateSlotPosition,
    showCart, setShowCart, toggleCart,
    expandedFleet, setExpandedFleet,
    selectedFleetForManagement, setSelectedFleetForManagement,
    sortColumn, sortDirection, handleSort, getSortedOutfits,
    showDeploymentModal, setShowDeploymentModal,
    deploymentContext, setDeploymentContext,
    selectedMissionType, setSelectedMissionType,
    selectedROE, setSelectedROE,
    deploymentStep, setDeploymentStep,
    selectedUnitsForDeployment, setSelectedUnitsForDeployment,
    activeDeployments, setActiveDeployments,
    showActiveDeployments, setShowActiveDeployments,
    equipCapability, unequipMountPoint, getCompatibleCapabilities,
    initiateDeployment, executeDeployment, navigateToCapability
  } = useMarketplaceStore();
